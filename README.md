...
This repository copy is prepared for handover and archival purposes.

- The main attempted change is in `starVLA/model/framework/QwenGR00T.py`.
- A brief Chinese handover note is available at `docs/visual_patch_compressor_handover_zh.md`.
- The attempted `VisualPatchCompressor` integration was not fully validated because the run hit an out-of-memory issue.
